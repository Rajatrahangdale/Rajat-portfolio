...
const socialLinks = [
  {
    href: "https://github.com/Rajatrahangdale",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.linkedin.com/in/rajat-rahangdale-b5b607194/",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://x.com/rajatsrahangda1",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="pb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-2 lg:max-w-[12ch]">
            Contact me for collaboration
          </h2>
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[300ch]">
        ...
        <form
          action="https://getform.io/f/awngjjeb"
          method="POST"
